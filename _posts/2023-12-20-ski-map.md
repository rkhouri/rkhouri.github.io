...
- [Step 1: Create an image of the map](#step-1-create-an-image-of-the-map)
...
- [Step 2: Build out interactive features on site](#step-2-build-out-interactive-features-on-site)
  - [Step 2a: Change color of trail segment on hover](#step-2a-change-color-of-trail-segment-on-hover)
  - [Step 2b: Display static data in box on hover, so that I can display segment name, length, etc.](#step-2b-display-static-data-in-box-on-hover-so-that-i-can-display-segment-name-length-etc)
  ...
  - [Step 2i: Create label that identifies which video is playing](#step-2i-create-label-that-identifies-which-video-is-playing)
...
**Goal:** Edit static map with HTML and CSS to add a collection of interactive features.
...
### Step 2i: Create label that identifies which video is playing
