...
![](2023-02-13-color-r_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
...
![](2023-02-13-color-r_files/figure-gfm/unnamed-chunk-6-1.png)<!-- -->
...
![](2023-02-13-color-r_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
...
![](2023-02-13-color-r_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
...
![](2023-02-13-color-r_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
...
- Continuous: `scale_color_paletteer_c("packagename::palettename")`
  ...
  ![](2023-02-13-color-r_files/figure-gfm/unnamed-chunk-10-1.png)<!-- -->
  ...
  ![](2023-02-13-color-r_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
- Color-vision-deficiency (CVD) simulation is possible with the
  ...
  ![](2023-02-13-color-r_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
- CVD stimulation is also possible with individual colors or colors in a
  ...
  ![](2023-02-13-color-r_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->

  ``` r
  colorBlindness::displayAllColors(paletteer_c("viridis::inferno", n = 10))
  ```

  ![](2023-02-13-color-r_files/figure-gfm/unnamed-chunk-13-2.png)<!-- -->
...
- You can also use this package to correct your colors and replace them
  ...
  ![](2023-02-13-color-r_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->

  ``` r
  cvdPlot(replacePlotColor(p))
  ```

  ![](2023-02-13-color-r_files/figure-gfm/unnamed-chunk-14-2.png)<!-- -->
...
{: .box-note} **Note:** The iris dataset is included in base R.
...
Color choice in data viz: - [What to consider when choosing colors for
data visualization](https://blog.datawrapper.de/colors/). A great list
of considerations for designing visuals with helpful sample visuals,
from Datawrapper. - [Color Theory
terminology](https://www.linearity.io/blog/color-tone-terminology/)

Modifying color in R: - <https://r-graph-gallery.com/colors.html> -
[Changing ggplot2
colors](https://r-graph-gallery.com/ggplot2-color.html) - [R color
...
[Colors](https://r-charts.com/colors/) - [paletteer starter
guide](https://github.com/EmilHvitfeldt/paletteer) and comprehensive
[list of palettes](https://github.com/EmilHvitfeldt/r-color-palettes)
created by the package author - Samples of Palettes included in
paletteer package, with additional hex code and code samples, as well as
the ability to search palette names in a browser with CRTL+F:
[Palettes](https://r-charts.com/color-palettes/) and [paletteer
gallery](https://pmassicotte.github.io/paletteer_gallery/)

Accessibility: - Web Accessibility Guidelines: [Contrast &
